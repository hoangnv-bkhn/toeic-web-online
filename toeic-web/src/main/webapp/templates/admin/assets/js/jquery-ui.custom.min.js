    ...
    a.widget("ui.resizable", a.ui.mouse, {
        ...
        _respectSize: function (a) {
            var b = this._vBoundaries, c = this.axis, d = this._isNumber(a.width) && b.maxWidth && b.maxWidth < a.width,
                ...
                h = this.originalPosition.left + this.originalSize.width, i = this.position.top + this.size.height,
                j = /sw|nw|w/.test(c), k = /nw|ne|n/.test(c);
    ...
    a.ui.resizable, a.widget("ui.selectable", a.ui.mouse, {
        ...
        _intersectsWithPointer: function (a) {
            var b = "x" === this.options.axis || this._isOverAxis(this.positionAbs.top + this.offset.click.top, a.top, a.height),
                ...
                d = b && c, e = this._getDragVerticalDirection(), f = this._getDragHorizontalDirection();
        ...
        _createHandles: function () {
            var b, c, d = this.options,
                ...
                f = "<span class='ui-slider-handle ui-state-default ui-corner-all' tabindex='0'></span>", g = [];
