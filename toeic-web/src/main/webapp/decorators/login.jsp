...
<%--    <title><dec:title default="Login Page"/></title>--%>
    ...
    <link rel="stylesheet" href="<c:url value = '/templates/admin/assets/font-awesome/4.2.0/css/font-awesome.min.css'/>" />

    <!-- page specific plugin styles -->

    <!-- text fonts -->
    <link rel="stylesheet" href="<c:url value = '/templates/admin/assets/fonts/fonts.googleapis.com.css'/>" />
