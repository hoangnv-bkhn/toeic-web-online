...
--%>
<%@ page import="web.core.web.common.WebConstant" %>
...
<head>
    ...
    <script src="<c:url value="/templates/countdown/countdown.js"/>" type="text/javascript"></script>
</head>
<body>
                ...
                <c:forEach items="${items.listResult}" var="item">
                    ...
                    <c:choose>
                        <c:when test="${item.type == PHOTO}">
                            <p>
                                <img src="<c:url value="/fileupload/exercise/${item.image}"/>" width="300px" height="150px">
                            </p>
                            <p>
                                <audio controls>
                                    <source src="<c:url value="/fileupload/exercise/${item.audio}"/>" type="audio/mpeg">
                                </audio>
                            </p>
                        </c:when>
