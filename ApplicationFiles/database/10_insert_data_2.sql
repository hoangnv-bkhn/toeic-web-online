...
VALUES ('image_1.jpg', 'audio_1.mp3', 'Look at the picture and listen to the sentences in the Part 1 TOEIC Test. Choose the sentence that best describes the picture:',
        'A', 'B', 'C', 'D', 'A', CURRENT_TIMESTAMP, 1);
INSERT INTO exercisequestion
(image, audio, question, option1, option2, option3, option4, correctanswer, createddate, exerciseid)
VALUES ('image_2.jpg', 'audio_2.mp3', 'Look at the picture and listen to the sentences in the Part 1 TOEIC Test. Choose the sentence that best describes the picture:',
        'A', 'B', 'C', 'D', 'B', CURRENT_TIMESTAMP, 1);
INSERT INTO exercisequestion
(image, audio, question, option1, option2, option3, option4, correctanswer, createddate, exerciseid)
VALUES ('image_3.jpg', 'audio_3.mp3', 'Look at the picture and listen to the sentences in the Part 1 TOEIC Test. Choose the sentence that best describes the picture:',
        'A', 'B', 'C', 'D', 'C', CURRENT_TIMESTAMP, 1);
INSERT INTO exercisequestion
(image, audio, question, option1, option2, option3, option4, correctanswer, createddate, exerciseid)
VALUES ('image_4.jpg', 'audio_4.mp3', 'Look at the picture and listen to the sentences in the Part 1 TOEIC Test. Choose the sentence that best describes the picture:',
