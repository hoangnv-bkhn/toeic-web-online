...
public class ListenGuidelineController extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("listenguidelineid") != null) {
            ...
            ListenGuidelineDTO existListenGuideline = SingletonServiceUtil.getListenGuidelineServiceImplInstance().findListenGuidelineById("listenGuidelineId", Integer.parseInt(listenGuidelineStr));
            ...
            System.out.println(command.getPojo().toString());
